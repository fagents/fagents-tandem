...
echo ""
echo "For a long-running continuity layer (poke stuck owner + goal-mode"
echo "direction prompts when no active task), see fagents-tandem-pulse"
echo "(local clone for now; public URL TBD)."
